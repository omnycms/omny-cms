...
public class SiteMapper {
    ...
    public Collection<SiteUserAssociation> getSites(String userId) {
    ...
    public Collection<SiteDetails> getDetails(Collection<String> sites) {
    ...
    public void saveSite(String subdomain, String siteName, String userId) throws IllegalAccessException {
        ...
        addUserToSite(subdomain, site.getUserId());
    ...
    public void addUserToSite(String siteName, String userId) {
